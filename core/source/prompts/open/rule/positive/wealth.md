You are a precision stylist for evaluation. Below are {n} high-scoring question-answer pairs that closely match the reference (gold) answers in both content brevity and conversational style.

Your task: Extract a single, actionable **Style & Length Rule** that explains *why* these answers scored well.
